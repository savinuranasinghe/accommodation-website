...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         <p>Name <span>*</span></p>
         <input type="text" name="property_name" required maxlength="50" placeholder=" name" class="input">
      </div>
      <div class="flex">
         <div class="box">
      ...
      <input type="submit" value="Post Ad" class="btn" name="post">
   </form>

</section>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBLzL7P-vZ8HjYpvnX2WfzLAAiO9UeAij8&libraries=places"></script>
...
function initMap() {
  ...
  map.addListener('click', function(e) {
    ...
    // Update the address field with the latitude and longitude
